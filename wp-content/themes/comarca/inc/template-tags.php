...
if ( ! function_exists( 'comarca_entry_meta' ) ) :
/**
 * Prints HTML with meta information for the categories, tags.
 *
 * @since Twenty Fifteen 1.0
 */
function comarca_entry_meta() {
	if ( is_sticky() && is_home() && ! is_paged() ) {
		printf( '<span class="sticky-post">%s</span>', __( 'Featured', 'comarca' ) );
	}
...
//				_x( 'Author', 'Used before post author name.', 'comarca' ),
...
//				_x( 'Categories', 'Used before category names.', 'comarca' ),
//				$categories_list
//			);
...
//				_x( 'Tags', 'Used before tag names.', 'comarca' ),
//				$tags_list
//			);
//		}
//	}
...
if ( ! function_exists( 'comarca_post_thumbnail' ) ) :
/**
 ...
 * @since Comarca 1.0
 */
function comarca_post_thumbnail() {
